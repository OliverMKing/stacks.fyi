...
const IndexComponent: React.FC = () => {
    ...
    <div className="w-full container mx-auto">
        ...
        <div className="flex flex-wrap">
          <div className="w-full sm:w-1/2 p-6 pb-0">
            ...
            <p className="text-gray-600 mb-8">
              ...
              State, and Country. Keep up-to-date with the trends in your area.
            </p>
          </div>
      ...
      <div className="container bg-red-400 sm:rounded-md py-8 sm:mb-8 text-center">
        ...
        <div className="w-full text-center pt-4">
          <form onSubmit={submitform}>
            <div className="max-w-xs md:max-w-sm mx-auto pr-3 p-1  bg-white rounded shadow flex items-center">
              <input
      ...
      <div className="container max-w-5xl text-center mx-auto mt-4 py-4 sm:border-t">
        <p className="text-gray-600">
          ...
          <a
            href="https://www.pixeltrue.com/illustrations"
            target="_blank"
  ...
  return (
    <div>
      <div
        className="bg-cover bg-gray-100 hidden xl:block"
        style={{ backgroundImage: "url(" + blob + ")" }}
      >
        {content}
      </div>
      <div
        className="bg-cover bg-gray-100 hidden lg:block xl:hidden"
        style={{ backgroundImage: "url(" + blob2 + ")" }}
      >
        {content}
      </div>
      <div className="bg-cover bg-gray-100 block lg:hidden">{content}</div>
    </div>
  );
};
